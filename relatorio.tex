...
mudar \texttt{Reset=0}, e clicar no Clock repetidamente observando os probes. Caso falha,
clicar no componente da CPU e alterar o caminho do arquivo \texttt{riscv\_cpu\_all.v} para o local correto.
